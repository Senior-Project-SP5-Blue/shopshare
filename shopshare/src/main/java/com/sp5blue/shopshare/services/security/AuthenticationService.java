...
public class AuthenticationService implements IAuthenticationService {
  ...
  @Transactional
  @Async
  public CompletableFuture<Void> signUp(SignUpRequest request) throws UserAlreadyExistsException {
    CompletableFuture<Boolean> getUsernameExists =
        userService.userExistsByUsername(request.username());
  ...
  public CompletableFuture<AuthenticationResponse> signIn(SignInRequest request) {
    ...
    return CompletableFuture.completedFuture(
        new AuthenticationResponse(accessJwt, refreshJwt, new UserDto(loggerInUser)));
  }

  @Override
  @Transactional
  @Async
  public CompletableFuture<Void> confirmEmail(String token) throws InvalidTokenException {
  ...
  @Transactional
  @Async
  public CompletableFuture<Void> saveUserToken(User user, String token, TokenType tokenType) {
  ...
  @Transactional
  @Async
  public CompletableFuture<Void> saveUserTokens(Token... tokens) {
  ...
  public void refreshToken(HttpServletRequest request, HttpServletResponse response) {
    ...
    if (!jwtService.extractRefreshStatus(refreshToken))
      throw new InvalidTokenException("Token is not a valid refresh token - " + refreshToken);
    ...
    if (userName != null) {
      ...
      if (jwtService.validateToken(refreshToken, user)) {
        ...
        AuthenticationResponse authenticationResponse =
            new AuthenticationResponse(accessToken, refreshToken, new UserDto((user)));
