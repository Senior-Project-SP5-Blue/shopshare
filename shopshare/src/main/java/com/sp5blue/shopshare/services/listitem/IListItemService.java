...
public interface IListItemService {
  ...
  CompletableFuture<ListItemDto> addListItemToList(
      UUID userId, UUID groupId, UUID listId, CreateListItemRequest listItemDto);

  CompletableFuture<ListItem> createListItem(
  ...
  CompletableFuture<ListItemDto> getListItemById(
      UUID userId, UUID groupId, UUID listId, UUID itemId) throws ListNotFoundException;

  CompletableFuture<ListItem> readListItemById(UUID userId, UUID groupId, UUID listId, UUID itemId)
  ...
  CompletableFuture<ListItem> editListItem(
