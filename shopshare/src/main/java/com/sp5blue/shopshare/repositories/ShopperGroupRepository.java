...
WHERE sg.name =:name
""")
    Page<ShopperGroup> findAllByUserIdAndName(@Param("user_id") UUID userId, @Param("name") String name, Pageable pageable);
...
WHERE sg.name =:name
""")
    List<ShopperGroup> findAllByUserIdAndName(@Param("user_id") UUID userId, @Param("name") String name);
...
WHERE u.id = :user_id
AND sg.id = :group_id""")
    Optional<ShopperGroup> findByUserIdAndId(@Param("user_id") UUID userId, @Param("group_id") UUID groupId);
