...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("SELECT DISTINCT u FROM ShopperGroup shopperGroup JOIN shopperGroup.users u JOIN FETCH u.roles WHERE shopperGroup.id = :group_id ORDER BY u.username")
