...
public class ShopperGroupRestExceptionHandler {
  @ExceptionHandler
  public ResponseEntity<ShopperGroupErrorResponse> handleException(
      GroupNotFoundException exception) {
    ShopperGroupErrorResponse error =
        new ShopperGroupErrorResponse(
  ...
  @ExceptionHandler
  public ResponseEntity<ShopperGroupErrorResponse> handleException(
      UserNotInvitedException exception) {
    ShopperGroupErrorResponse error =
        new ShopperGroupErrorResponse(
  ...
  @ExceptionHandler
  public ResponseEntity<ShopperGroupErrorResponse> handleException(
      UserAlreadyInGroupException exception) {
    ShopperGroupErrorResponse error =
        new ShopperGroupErrorResponse(
            HttpStatus.BAD_REQUEST.value(), exception.getMessage(), LocalDateTime.now());
    return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
