...
public class ShoppingListController implements ShoppingListControllerBase {
    ...
    @Override
    @GetMapping("/{group_id}/shopping-lists")
    ...
    @Override
    @PostMapping("/{group_id}/shopping-lists")
    ...
    @Override
    @GetMapping("/{group_id}/shopping-lists/{shopping-list_id}")
    ...
    @Override
    @PatchMapping("/{group_id}/shopping-lists/{shopping-list_id}")
    ...
    @Override
    @DeleteMapping("/{group_id}/shopping-lists/{shopping-list_id}")
