...
public class AuthRestExceptionHandler {
  ...
  public ResponseEntity<AuthErrorResponse> handleException(TokenNotFoundException exception) {
    AuthErrorResponse error =
        new AuthErrorResponse(
            HttpStatus.UNAUTHORIZED.value(), "Access denied. Please log in.", LocalDateTime.now());
  ...
  public ResponseEntity<AuthErrorResponse> handleException(BadCredentialsException exception) {
    AuthErrorResponse error =
        new AuthErrorResponse(
            HttpStatus.UNAUTHORIZED.value(), exception.getMessage(), LocalDateTime.now());
    return new ResponseEntity<>(error, HttpStatus.UNAUTHORIZED);
  }
  ...
  public ResponseEntity<AuthErrorResponse> handleException(InvalidTokenException exception) {
    AuthErrorResponse error =
        new AuthErrorResponse(
            ...
            "Invalid permissions. Please log in.",
            LocalDateTime.now());
    return new ResponseEntity<>(error, HttpStatus.UNAUTHORIZED);
  }
