...
import com.sp5blue.shopshare.services.shopper.ShopperService1;
...
class ShopperGroupService1Test {

    @Mock
    ShopperService1 shopperService1;

    @Mock
    ShopperGroupRepository shopperGroupRepository;

    @InjectMocks
    ShopperGroupService1 shopperGroupService1;
    ...
    void createShopperGroup_CreatesShopperGroup() {
        ...
        when(shopperService1.readShopperById(shopper.getId())).thenReturn(shopper);
    ...
    void deleteShopperGroup_Member_RemovesShopperFromShopperGroup() {
        ...
        when(shopperService1.readShopperById(shopper1.getId())).thenReturn(shopper1);
